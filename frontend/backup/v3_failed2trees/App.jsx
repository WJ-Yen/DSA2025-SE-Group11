...
export default function App() {
    ...
    const [currentOperation, setCurrentOperation] = useState('construct'); // 'construct', 'query', or 'update'
            ...
            <div className="grid grid-cols-[300px_1fr_150px] grid-rows-[50px_1fr_auto] gap-2 h-full">
                ...
                <div className="col-span-2 p-4">
                    ...
                    <DisplayTree 
                        ...
                        currentOperation={currentOperation} // Add this
                    />
                </div>
                ...
                <InputBar 
                    ...
                    setCurrentOperation={setCurrentOperation} // Add this
                />
